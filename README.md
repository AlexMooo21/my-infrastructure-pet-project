#  Infrastructure pet Project
📌 Описание

Инфраструктурный пет-проект, демонстрирующий построение инфраструктуры из нескольких виртуальных машин с локальным DNS, мониторингом, алертингом и контейнеризацией Python-приложения.
...
· Практика System-administration/DevOps/SRE-навыков
